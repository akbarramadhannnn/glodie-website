...
const Team = (props) => {
  ...
  return (
    <Fragment>
      <Head title="Glodie | Team" urlLink={props.urlPath} />
      ...
      <section className="min-h-1xl pl-5 pr-5 lg:pl-16 lg:pr-16 xl:pl-40 xl:pr-40 pt-10 pb-10">
        {props.dataTeams.map((d, i) => {
          return (
            <div
              className={`flex ${
                props.dataTeams.length - 1 === i ? "" : "mb-10"
              }`}
              key={i}
            ...
            >
              ...
              <div className="w-4/5 h lg:pt-6 lg:pb-6 pl-3 lg:pl-8 flex flex-col justify-between">
                <h1 className="text-pink1 text-md md:text-2xl lg:text-3xl font-bold mb-1">
                  {d.title}
                </h1>
